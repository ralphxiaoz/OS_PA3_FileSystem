...
public class TestBitwise {
    ...
    public void testIsSet() {
    	...
    	b = (byte) 0x88;
    	assertEquals(false, Bitwise.isset(7, b));
    ...
    public void testSet() {
        ...
        b = Bitwise.set(1, b);
        assertEquals("11000000", Bitwise.toString(b));
        b = Bitwise.set(1, b);
        assertEquals("11000000", Bitwise.toString(b));
        b = Bitwise.set(0, b);
        assertEquals("11000000", Bitwise.toString(b));
        b = Bitwise.set(5, b);
        assertEquals("11000100", Bitwise.toString(b));
    }
    ...
    public void testClear() {
        ...
        b = Bitwise.clear(0, b);
        assertEquals("01111111", Bitwise.toString(b));
        b = Bitwise.clear(7, b);
    ...
    public void testMultiClear() {
        ...
        Boolean wasClear = Bitwise.clear(0, bytes);
        ...
        assertEquals("01111111 00000001", Bitwise.toString(bytes, " "));
        wasClear = Bitwise.clear(1, bytes);
        assertEquals(true, wasClear);
        assertEquals("00111111 00000001", Bitwise.toString(bytes, " "));
        wasClear = Bitwise.clear(9, bytes);
        assertEquals(false, wasClear);
        assertEquals("00111111 00000001", Bitwise.toString(bytes, " "));
